...
def longest_nonzero_segment(arr):
    ...
    # Handle case where array ends in non-zero sequence
    if temp_start is not None:
...
if __name__ == "__main__":
    ...
    while True:
        ...
        for i in range(3):
            ...
            # Calculate the percentage of white pixels in the ellipse area
            ...
            # quick fix use rolling z score instead
            ellipse_ratio = ellipse[1][0] / ellipse[1][1] 
            # if total_pixels < 300 or angle > 30:
            #     percentage = 0
